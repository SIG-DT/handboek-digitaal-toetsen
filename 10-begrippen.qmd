...
```{r, echo=FALSE, eval=FALSE, fig.cap="Componenten van digitale toetssystemen afgebeeld op de toetscyclus.", out.width="40%"}
...
## Lerend Kwalificeren
Zie (https://onderwijsenexaminering.nl/lerend-kwalificeren/de-basis-van-lerend-kwalificeren-2/): Lerend kwalificeren is een vorm van afsluiting van de opleiding waarbij onderwijsteams gebruikmaken van diverse bewijzen verzameld tijdens het leerproces van studenten om beslissingen te nemen over het al dan niet voldoen aan (een deel van de) kwalificatie-eisen. Deze werkwijze is gebaseerd op het concept van programmatisch toetsen, waarbij datapunten fungeren als pixels die het leren van de student weergeven. Verschillende vormen van beoordeling dienen als datapunten, die samen een rijk beeld vormen van de competenties van de student.
