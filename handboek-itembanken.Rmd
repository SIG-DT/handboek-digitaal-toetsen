...
We gaan in dit handboek uit van de toetscyclus zoals beschreven in het [Begrippenkader voor digitaal toetsen van SURF uit 2013](link). Centraal staat het ontwikkelen van items (het itemontwikkelproces) en het beheer van items in een itembank. Een goede itembank vormt de basis voor goede toetsen. Over hoe je op basis van zo’n itembank goede toetsen ontwikkelt in een toetssysteem, zijn andere bronnen beschikbaar, zoals [@Toetsen in het hoger onderwijs] van Berkel, Bax en Joosten-ten Brinke.   
...
**[deKennistoetsenbank MBO](https://www.provetomove.nl/dekennistoetsenbank)**  
...
**[10voordeleraar](https://www.10voordeleraar.nl)**  
...
**[Sharestats](https://www.sharestats.nl)**  
...
2. Plan  <br>Maak een plan van aanpak, waarin je beschrijft:  
    * het doel;  
...
* Zorg voor goede documentatie, zoals:
    ...
    * een beschrijving van het onderhoud van de itembank voor een eventueel coördinatieteam en voor elk auteursteam per itembank. *(Zie § 16.2.3.)*
...
<!--chapter:end:02-stappenplan.Rmd-->
...
**![Figuur 2](Images/Processtappen.png)**  
**Figuur 2**

In figuur 2 staat een uitwerking van een aantal processtappen die binnen de verschillende componenten van een toetssysteem kunnen plaatsvinden.
...
**![Figuur 3](Images/metadata.png)**

**Figuur 3**: Een item met enkele metadatavelden ingevuld. 
...
**![Figuur 4](Images/fig4.png)**

**Figuur 4**: Het VUmc heeft een aparte itembank binnen het itembanksysteem van Questionmark Perception. De hoofdstructuur van het VUmc volgt de afzonderlijke cursusafhankelijke toetsen (CAT) die worden afgenomen in het curriculum. 

**![Figuur 5](Images/categories.jpg)**

**Figuur 5**: De hoofdstructuur voor een itembank over statistiek van de Faculteit der Sociale   Wetenschappen van de VU. Deze itembank bevindt zich in een cursus in Blackboard. De itembank volgt de onderwerpindeling binnen statistiek met verbijzondering naar Advanced/Basic en Moeilijkheidsgraad. 

**![Figuur 6](Images/iQualify.jpg)**

**Figuur 6**: DeKennistoetsenbank bevat itembanken voor gebruikers van Pedagogisch Werk (PW), Maatschap- pelijke Zorg (MZ) en Verpleegkundige en Verzorgende opleidingen MBO Zorg en Welzijn. Deze itembanken zijn ingedeeld naar: vraagtypen, de structuur van de Body of Knowledge (BoK), het Kwalificatie Dossier (KD) en bijzondere kenmerken. In de afbeelding is de inrichting van de itembank van Pedagogisch Werk (PW) weergegeven.

**![Figuur 7](Images/fig7.jpg)**

**Figuur 7**: Een docent van de cursus Inleiding Microbiologie heeft een itembank in QuestionmarkLive gemaakt. De indeling volgt exact de hoofdstukindeling van het studieboek dat hij gebruikt.

**![Figuur 8](Images/fig8.jpg)**

**Figuur 8**: Indeling vragenbank LUMC. In het itembanksysteem RemindoToets heeft het Leids Universitair Medisch Centrum (LUMC) een itembank.

**![Figuur 8.1](Images/vragenbank.jpg)**

**Figuur 8.1**: In eerste instantie koos het LUMC voor een themagerichte indeling op basis van disciplines uit de landelijke Voortgangstoets. Deze structuur leidde tot problemen vanwege de gebrekkige vind- baarheid van items voor docenten en het beheer van de vragen door docenten.

**![Figuur 8.2](Images/categorieen.jpg)**

**Figuur 8.2**: Inmiddels is voor een meer pragmatische ordening naar opleidingen en onderwijs- onderdelen gekozen.

**![Figuur 9](Images/vragen.jpg)**

**Figuur 9**: Structuur van de itembank van Toets & Leer.
Iedere itembank binnen het itembanksysteem RemindoToets van Toets & Leer is uit drie niveaus (categorieën) opgebouwd: Onderwerp > Leerdoel > Toetsterm. Hierdoor klap je slechts drie niveaus uit om een toetsvraag te zoeken, namelijk onderwerp, leerdoel en toetsterm. Het is de kunst geweest om de lijst met onderwerpen niet te algemeen, maar ook niet te gedetailleerd te maken.
...
**![Figuur 10](Images/fig10.png)**

**Figuur 10**: Een itembank met als hoofdstructuur een indeling van hoofdstukken. Vragen kunnen worden gefilterd op basis van verschillende categorieën van metadata.
...
Er zijn veel handboeken en lijstjes met vuistregels om de meest bekende oorzaken voor onduidelijke items te voorkomen en daarmee de ruis. Zie bijvoorbeeld Van Berkel, H. J. M., Bax, A., & Joosten-ten Brinke, D. (2017). Toetsen in het Hoger Onderwijs. (4rd ed.). Houten/Diegem: Bohn Stafleu Van Loghum.

::::

### Hoe realiseer je een kwaliteitsverbetering?

Je verhoogt de kwaliteit van items door fluctuatie in kwaliteit van items te verminderen en de vraagkwaliteit op een hoger niveau te krijgen. Dit inzicht komt voort uit het vakgebied van de operations management, zoals geïllustreerd in figuur 11. In het linker plaatje zie je dat de kwaliteit van een product of dienst gemiddeld vrij laag is, dan weer eens hoog en dan weer eens laag, maar niet stijgend. Het rechter- plaatje laat zien dat de kwaliteit gestaag toeneemt en de fluctuatie kleiner wordt. Om een dergelijke kwaliteitsverbetering te realiseren, is een doelgerichte benadering nodig.

**![Figuur 11](Images/fig11.jpg)**

**Figuur 11**: Grafische weergave van kwaliteitsontwikkeling. Links: de kwaliteit varieert heel erg, de gemiddelde kwaliteit is relatief laag. Rechts: de kwaliteit wordt constanter en de kwaliteit neemt systematisch toe.
